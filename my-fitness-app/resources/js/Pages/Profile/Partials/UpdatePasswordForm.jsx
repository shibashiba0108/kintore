...
import "../../../../css/profile.css";  // CSSをインポート
...
export default function UpdatePasswordForm({ className = '' }) {
    ...
    return (
        <section className={`form-section ${className}`}>
            <header>
                <h2 className="form-header">パスワードの更新</h2>
                <p className="form-description">
                    アカウントのセキュリティを強化するために、長くてランダムなパスワードを使用してください。
                </p>
            </header>
            ...
            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                ...
                <div className="flex items-center gap-4">
                    <PrimaryButton className="primary" disabled={processing}>保存</PrimaryButton>
                    <Transition
